...
<main class="container py-5">
    <section class="text-center mb-5">
        ...
        if (isset($_SESSION['usuario'])) {
            ...
            echo "<h2 class='fs-4 fw-semibold'>¡Bienvenido a <span class='text-purple'>IT Juniors</span>!</h2>";
        }
        ?>
        <p class="fs-5 mt-3">
            IT Juniors es una plataforma digital pensada para ayudarte a impulsar tu carrera en el sector tecnológico.
    ...
    <div class="row align-items-center mb-5">
        ...
        <div class="col-md-6">
            <section class="bg-light p-4 rounded shadow-sm">
                <h3 class="fs-5 fw-bold">¿Quién está detrás de IT Juniors?</h3>
    ...
    <section class="mt-5 text-center">
        <p class="fs-6">
            Tanto si estás dando tus primeros pasos en el mundo IT como si eres una empresa buscando talento, IT Juniors
            es el lugar ideal para crecer, conectar y avanzar.
        </p>
    </section>
</main>
